  ...
  async (postForum, { rejectWithValue, getState, dispatch }) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        "https://givly-api.onrender.com/api/posts",
        formData,
        config
      );
      //dispatch action
  ...
  async (postForum, { rejectWithValue, getState, dispatch }) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://givly-api.onrender.com/api/posts/${postForum?.id}`,
        postForum,
        config
      );
      //dispatch
  ...
  async (postForumId, { rejectWithValue, getState, dispatch }) => {
    ...
    try {
      ...
      const { data } = await axios.delete(
        `https://givly-api.onrender.com/api/posts/${postForumId}`,
        config
      );
      //dispatch
...
export const fetchPostsAction = createAsyncThunk(
  ...
  async ({ rejectWithValue, getState, dispatch }) => {
    try {
      const { data } = await axios.get(`https://givly-api.onrender.com/api/posts`);
      return data;
    } catch (error) {
      if (!error?.response) throw error;
      return rejectWithValue(error?.response?.data);
...
export const toggleAddLikesToPost = createAsyncThunk(
  ...
  async (postForumId, { rejectWithValue, getState, dispatch }) => {
    ...
    try {
      const { data } = await axios.put(
        `https://givly-api.onrender.com/api/posts/likes`,
        { postForumId },
        config
      );
...
export const toggleAddDisLikesToPost = createAsyncThunk(
  ...
  async (postForumId, { rejectWithValue, getState, dispatch }) => {
    ...
    try {
      const { data } = await axios.put(
        `https://givly-api.onrender.com/api/posts/dislikes`,
        { postForumId },
        config
      );
